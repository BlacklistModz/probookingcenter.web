...
?><div data-load="<?=URL?>admin/settings/members" class="SettingCol offline">

<div class="SettingCol-header"><div class="SettingCol-contentInner">
	<div class="clearfix">
		<ul class="clearfix lfloat SettingCol-headerActions">

			<li><h2><i class="icon-users mrs"></i><span><?=$this->lang->translate('Members')?></span></h2></li>
	...
	<div class="mtm clearfix">
		<ul class="lfloat SettingCol-headerActions clearfix">
			...
			<li><label>Display:</label> 
				<select ref="selector" name="enabled" class="inputtext">
					<option value="1"><?=$this->lang->translate("Enabled")?></option>
					<option value="0"><?=$this->lang->translate("Disabled")?></option>
				</select>
			</li> -->
