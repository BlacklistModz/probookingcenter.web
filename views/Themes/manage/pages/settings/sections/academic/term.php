...
?><div data-load="<?=$this->pageURL?>settings/academic/term" class="SettingCol offline">

<div class="SettingCol-header"><div class="SettingCol-contentInner">
	<div class="clearfix">
		<ul class="clearfix lfloat SettingCol-headerActions">

			<li><h2><i class="icon-book mrs"></i><span>ภาคเรียน</span></h2></li>
			<li><a class="btn js-refresh"><i class="icon-refresh"></i></a></li>
			<li class="divider"></li>

			<li><a class="btn btn-blue" data-plugins="dialog" href="<?=$url?>add_term"><i class="icon-plus mrs"></i><span>เพิ่ม</span></a></li>
	...
	<div class="mtm clearfix">
		<ul class="lfloat SettingCol-headerActions clearfix">
			<li><label>ปีการศึกษา:</label> 
				<select ref="selector" name="year" class="inputtext">
					<option value="">--- เลือกปีการศึกษา ---</option>
					<?php 
					foreach ($this->year['lists'] as $key => $value) {
...
<div class="SettingCol-main">
	<div class="SettingCol-tableHeader"><div class="SettingCol-contentInner">
		<table class="settings-table admin"><thead><tr>
			<th class="name" data-col="0">ภาคเรียน</th>
			<th class="event_date" data-col="0">ระยะเวลา</th>
