...
?><div data-load="<?=$this->pageURL?>settings/student/majors" class="SettingCol offline">

<div class="SettingCol-header"><div class="SettingCol-contentInner">
	<div class="clearfix">
		<ul class="clearfix lfloat SettingCol-headerActions">

			<li><h2><i class="icon-cube mrs"></i><span><?=$this->lang->translate('Majors')?></span></h2></li>
			<li><a class="btn js-refresh"><i class="icon-refresh"></i></a></li>
			<li class="divider"></li>

			<li><a class="btn btn-blue" data-plugins="dialog" href="<?=$url?>add_majors"><i class="icon-plus mrs"></i><span>เพิ่ม</span></a></li>
	...
	<div class="mtm clearfix">
		<ul class="lfloat SettingCol-headerActions clearfix">
			<li><label><?=$this->lang->translate('Faculty')?>:</label> 
...
<div class="SettingCol-main">
	<div class="SettingCol-tableHeader"><div class="SettingCol-contentInner">
		<table class="settings-table admin"><thead><tr>
			<th class="name" data-col="0">ชื่อสาขาวิชา</th>
