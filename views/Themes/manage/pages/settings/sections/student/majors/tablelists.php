    ...
    foreach ($this->results['lists'] as $i => $item) { 
        ...
        $tr .= '<tr class="'.$cls.'" data-id="'.$item['id'].'">'.
            ...
            '<td class="name">'.
                ...
                '<div class="anchor clearfix">'.
                    ...
                    '<div class="content"><div class="spacer"></div><div class="massages">'.
                        ...
                        '<div class="subname fsm fcg meta">'.$item['faculty_name'].'</div>'.
            ...
            '<td class="actions whitespace">
                <span class="gbtn"><a data-plugins="dialog" href="'.$url.'edit_majors/'.$item['id'].'" class="btn btn-no-padding"><i class="icon-pencil"></i></a></span>
                <span class="gbtn"><a data-plugins="dialog" href="'.$url.'del_majors/'.$item['id'].'" class="btn btn-no-padding"><i class="icon-trash"></i></a></span>
            </td>'.
